...
class RealisticSalesDataGenerator():
    """Generate realistic data with multiple files, partitions and business patterns """
    def __init__(self, start_date:str= '2024-01-01',end_date:str='2024-12-31'):
        self.start_date= pd.to_datetime(start_date)
        self.end_date  = pd.to_datetime(end_date)
        self.in_holidays= holidays.coutry_holidays('IN')

        # Store configurations
        self.stores = {
            'store_001': {'location': 'New Delhi', 'size': 'large', 'base_traffic': 1000},
            'store_002': {'location': 'Noida', 'size': 'large', 'base_traffic': 950},
            'store_003': {'location': 'Banglore', 'size': 'medium', 'base_traffic': 700},
            'store_004': {'location': 'Chennai', 'size': 'medium', 'base_traffic': 650},
            'store_005': {'location': 'Pune', 'size': 'small', 'base_traffic': 400},
            'store_006': {'location': 'Mumbai', 'size': 'medium', 'base_traffic': 600},
            'store_007': {'location': 'Hyderabad', 'size': 'small', 'base_traffic': 350},
            'store_008': {'location': 'Jodhpur', 'size': 'medium', 'base_traffic': 550},
            'store_009': {'location': 'Goa', 'size': 'large', 'base_traffic': 850},
            'store_010': {'location': 'Kolkata', 'size': 'medium', 'base_traffic': 600}
        }       
    ...
    def generate_promotions(self) -> pd.DataFrame:
        ...
        major_events = [
            ...
            ('Independence Day', 2, 15, 3, 0.15),
            ('Republic Day', 5, 25, 3, 0.15),
